...
//echo "LOCO<br>";
if (!empty($_REQUEST["sendSms"]) || $_GET['sendSms']) {
  //echo "Trigger?<br>";
  $_SESSION["sms1_smsMsg"] = $_POST['message'];
  if($_GET['message']) {
     $_SESSION["sms1_smsMsg"] = $_GET['message'];
     //echo "_GET[message] = ".$_GET['message']."<br>";
    // echo "_SESSION[sms1_smsMsg] = ".$_SESSION["sms1_smsMsg"]."<br>";
  }
  $_SESSION["sms1_address"] = $_POST['address'];
  if($_GET['address']){
     $_SESSION["sms1_address"] = $_GET['address'];
     //echo "_GET[address]= ".$_GET['address']."<br>";
     //echo "_SESSION[sms1_address]= ".$_SESSION["sms1_address"]."<br>";
  }
 }
...
<?php
	...
	*/
    if (!empty($_REQUEST["sendSms"])) {
      ...
      $address =  str_replace("-","",$_SESSION["sms1_address"]);
